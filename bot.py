...
def extract_clean_text(response_data: dict) -> str:
    ...
    try:
        ...
        if 'outputs' in response_data and response_data['outputs']:
            ...
            if 'outputs' in outputs and outputs['outputs']:
                ...
                if 'message' in results:
                    return results['message'].get('text', '')
                
        # Fallback: try to find text in other common locations
        ...
        return "I couldn't process that properly."
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    try:
        ...
        clean_response = extract_clean_text(result)
        
        # Split response if needed and send
        message_chunks = split_message(clean_response)
